...
export function ConversionTheme({ profile, links, socials, videos, banners, track }: BioThemeProps) {
  ...
  const accent = profile.button_color || '#EA580C';
    ...
    >
      {s.urgencyBar && (
        ...
        >
          ...
          {URGENCY_TEXT[s.urgencyText] || URGENCY_TEXT.limited}
      ...
      <div className="relative max-w-md mx-auto px-5 pt-[72px] pb-16">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mt-1 text-sm opacity-70" style={{ color: text, fontWeight: 500 }}>
            @{profile.username}
          </div>
          ...
          {s.socialProof !== 'none' && (
            <div className="mt-4 flex items-center gap-2">
              ...
              <div className="flex items-center gap-1.5 text-xs font-semibold" style={{ color: text }}>
                ...
                {SOCIAL_COUNT[s.socialCount] || SOCIAL_COUNT['10k']} {SOCIAL_PROOF_LABEL[s.socialProof]}
              </div>
            </div>
          )}
