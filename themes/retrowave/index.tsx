...
export function RetrowaveTheme({ profile, links, socials, videos, banners, track }: BioThemeProps) {
  ...
  const accent = profile.button_color || pal.a;
    ...
    >
      ...
      <div className="relative max-w-md mx-auto px-5 pt-[72px] pb-24">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="text-xs tracking-[0.3em] uppercase mt-1" style={{ color: pal.c, textShadow: `0 0 6px ${pal.a}` }}>
            @{profile.username}
          </div>
        ...
        <div className="mt-8 flex flex-col gap-3">
          ...
          {banners?.map((b: any) => {
            const inner = (
              <div
                className={`overflow-hidden ${s.bannerTracking ? 'retro-track' : ''}`}
                style={{
                  border: `2px solid ${pal.c}`,
